...
if OS.mac?
  ...
  system "/Applications/Atom.app/Contents/Resources/app/apm/node_modules/.bin/apm install atom-ide-ui ide-python"
elsif OS.linux?
  ...
  system "/usr/bin/apm install atom-ide-ui ide-python"
end
